...
<head>
    <meta charset="utf-8">
    <title>Simple php login without database</title>
...
<body>
    <div class="container">
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="text-center"><a href="http://php-gym.com"><img src=" "></a></div><br>
        ...
        <?php echo $error; ?>
            ...
            <div class="panel panel-warning">
                <div class="panel-body">
                    <strong>Default username:</strong> demo <br>
                    <strong>Default password:</strong> demo
                </div>
            </div>
            <div class="row">
            </div>
